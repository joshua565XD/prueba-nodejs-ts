...
const alumno_schema_1 = require("./schemas/alumno.schema");
...
exports.AlumnoModule = AlumnoModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: alumno_schema_1.Alumno.name, schema: alumno_schema_1.AlumnoSchema }])
        ],
